...
# build directory.
jpegtcl_BUILD_LIB_SPEC='-L/c/build/camel/work/Img/libjpeg -ljpegtcl92'

# String to pass to linker to pick up the jpegtcl library from its
# installed directory.
jpegtcl_LIB_SPEC='-LC:/Users/build/AppData/Local/Temp/ActiveState-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/lib/Img1.4.6 -ljpegtcl92'
...
# build directory.
jpegtcl_BUILD_STUB_LIB_SPEC='-L/c/build/camel/work/Img/libjpeg -ljpegtclstub92'

# String to pass to linker to pick up the jpegtcl stub library from its
# installed directory.
jpegtcl_STUB_LIB_SPEC='-LC:/Users/build/AppData/Local/Temp/ActiveState-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/lib/Img1.4.6 -ljpegtclstub92'

# String to pass to linker to pick up the jpegtcl stub library from its
# build directory.
jpegtcl_BUILD_STUB_LIB_PATH='/c/build/camel/work/Img/libjpeg/jpegtclstub92.lib'

# String to pass to linker to pick up the jpegtcl stub library from its
# installed directory.
jpegtcl_STUB_LIB_PATH='C:/Users/build/AppData/Local/Temp/ActiveState-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/lib/Img1.4.6/jpegtclstub92.lib'
