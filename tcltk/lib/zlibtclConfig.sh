...
# build directory.
zlibtcl_BUILD_LIB_SPEC='-L/c/build/camel/work/Img/zlib -lzlibtcl1281'

# String to pass to linker to pick up the zlibtcl library from its
# installed directory.
zlibtcl_LIB_SPEC='-LC:/Users/build/AppData/Local/Temp/ActiveState-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/lib/Img1.4.6 -lzlibtcl1281'
...
# build directory.
zlibtcl_BUILD_STUB_LIB_SPEC='-L/c/build/camel/work/Img/zlib -lzlibtclstub1281'

# String to pass to linker to pick up the zlibtcl stub library from its
# installed directory.
zlibtcl_STUB_LIB_SPEC='-LC:/Users/build/AppData/Local/Temp/ActiveState-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/lib/Img1.4.6 -lzlibtclstub1281'

# String to pass to linker to pick up the zlibtcl stub library from its
# build directory.
zlibtcl_BUILD_STUB_LIB_PATH='/c/build/camel/work/Img/zlib/zlibtclstub1281.lib'

# String to pass to linker to pick up the zlibtcl stub library from its
# installed directory.
zlibtcl_STUB_LIB_PATH='C:/Users/build/AppData/Local/Temp/ActiveState-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/lib/Img1.4.6/zlibtclstub1281.lib'
