...
TCL_DEFS='-nologo -c /D_ATL_XP_TARGETING  -W3 -wd4311 -wd4312 -Fpc:\build\camel\work\tcl\win\Release_AMD64_VC1900\tcl_ThreadedDynamic\  -fp:strict -O2 -GS -GL -MD -I"c:\build\camel\work\tcl\win\..\win" -I"c:\build\camel\work\tcl\win\..\generic"  -I"c:\build\camel\work\tcl\win\..\libtommath"  /DTCL_TOMMATH /DMP_PREC=4 /Dinline=__inline /DHAVE_ZLIB=1 /D_CRT_SECURE_NO_DEPRECATE /D_CRT_NONSTDC_NO_DEPRECATE /DMP_FIXED_CUTOFFS /DSTDC_HEADERS /DUSE_NMAKE=1 /DHAVE_STDINT_H=1 /DHAVE_INTTYPES_H=1 /DHAVE_STDBOOL_H=1 /DTCL_THREADS=1 /DUSE_THREAD_ALLOC=1 /DNDEBUG /DTCL_CFG_OPTIMIZED /DTCL_CFG_DO64BIT   /DBUILD_tcl'
...
TCL_CFLAGS_DEBUG='-nologo -c -W3 -YX -Fpc:\build\camel\work\tcl\win\Release_AMD64_VC1900\tcl_ThreadedDynamic\ -MDd'
TCL_CFLAGS_OPTIMIZE='-nologo -c -W3 -YX -Fpc:\build\camel\work\tcl\win\Release_AMD64_VC1900\tcl_ThreadedDynamic\ -MD'
...
# compiled.
TCL_SRC_DIR='c:\build\camel\work\tcl\win\..'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-Lc:\build\camel\work\tcl\win\Release_AMD64_VC1900 tclstub86.lib'
...
TCL_BUILD_STUB_LIB_PATH='c:\build\camel\work\tcl\win\Release_AMD64_VC1900\tclstub86.lib'
