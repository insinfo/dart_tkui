...
# build directory.
tifftcl_BUILD_LIB_SPEC='-L/c/build/camel/work/Img/libtiff -ltifftcl397'

# String to pass to linker to pick up the tifftcl library from its
# installed directory.
tifftcl_LIB_SPEC='-LC:/Users/build/AppData/Local/Temp/ActiveState-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/lib/Img1.4.6 -ltifftcl397'
...
# build directory.
tifftcl_BUILD_STUB_LIB_SPEC='-L/c/build/camel/work/Img/libtiff -ltifftclstub397'

# String to pass to linker to pick up the tifftcl stub library from its
# installed directory.
tifftcl_STUB_LIB_SPEC='-LC:/Users/build/AppData/Local/Temp/ActiveState-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/lib/Img1.4.6 -ltifftclstub397'

# String to pass to linker to pick up the tifftcl stub library from its
# build directory.
tifftcl_BUILD_STUB_LIB_PATH='/c/build/camel/work/Img/libtiff/tifftclstub397.lib'

# String to pass to linker to pick up the tifftcl stub library from its
# installed directory.
tifftcl_STUB_LIB_PATH='C:/Users/build/AppData/Local/Temp/ActiveState-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/lib/Img1.4.6/tifftclstub397.lib'
