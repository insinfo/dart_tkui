...
#
# ActiveState ActiveTcl 8.6.12.0 , 
#
...
namespace eval ::activestate {
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.6.12.0  @  6c53c071ed1a2dc3ced52bdbdd87714231aecf32 / normal}
    }
}

package provide {ActiveTcl} {8.6.12.0}
